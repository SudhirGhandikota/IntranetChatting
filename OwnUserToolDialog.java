...
public class OwnUserToolDialog
    extends Dialog
    implements ActionListener, ItemListener, KeyListener, WindowListener
{
    private OwnUserTool userTool = new OwnUserTool();

    protected OwnServerWindow parentWindow;
    ...
    public OwnUserToolDialog(OwnServerWindow parent)
    {
	...
	try {
	    ...
	    new OwnInfoDialog(parentWindow, "Error creating user",
				  true, e.toString());
	    return;
	}
	...
	for (int count = 0; count < users.length; count ++)
		...
		try {
		    ...
		    new OwnInfoDialog(parentWindow, "Error deleting user",
					  true, e.toString());
		    return;
		}
	    }
